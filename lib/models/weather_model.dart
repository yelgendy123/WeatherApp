...
class WeatherModel {
  ...
  String getImage() {
    if (weatherStateName == 'Sunny' || weatherStateName == 'Clear' ||  weatherStateName == 'partly cloudy') {
      return 'http://cdn.weatherapi.com/weather/64x64/day/116.png';
    } else if (
    ...
    weatherStateName == 'Blizzard' ||  weatherStateName == 'Patchy snow possible'  ||  weatherStateName == 'Patchy sleet possible' || weatherStateName == 'Patchy freezing drizzle possible' || weatherStateName == 'Blowing snow') {
      ...
      return 'http://cdn.weatherapi.com/weather/64x64/night/143.png';
    } else if (weatherStateName == 'Patchy rain possible' ||
        weatherStateName == 'Heavy Rain' ||
        weatherStateName == 'Showers	') {
      return 'http://cdn.weatherapi.com/weather/64x64/night/326.png';
      ...
      return 'http://cdn.weatherapi.com/weather/64x64/night/389.png';
    } else {
      return 'http://cdn.weatherapi.com/weather/64x64/night/113.png';
    }
  }
